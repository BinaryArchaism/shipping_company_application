INSERT INTO baltika.ports (Name, Address, Lat, Long) VALUES
                                                         ('Seafarer Bay Port', '123 Nautical Blvd, Ocean City, Atlantis', 45.678901, -56.789012),
...
INSERT INTO baltika.ships_type (type) VALUES
                                          ('tanker'),
                                          ('bulk-carrier');

INSERT INTO baltika.ships (RegNumber, Name, Skipper, Type, Capacity, Year, Picture, Dockyard) VALUES
                                                                                                  (12345, 'Sea Voyager', 'Captain Johnson', 2, 200, 2015, ARRAY['ship1.jpg'], 1),
...
INSERT INTO baltika.sender (Sender, INNsender, BankSender, AddressSender) VALUES
                                                                              ('ABC Trading Co.', 1234567890, 'Ocean Bank', '123 Main Street, City A, Country A'),
...
-- Mock data for baltika.sender
INSERT INTO baltika.sender (Sender, INNsender, BankSender, AddressSender) VALUES
                                                                              ('Oceanic Trade Hub', 1234567890, 'Ocean Bank', '123 Atlantis Avenue, Neptune City, Atlantis'),
...
INSERT INTO baltika.consignee (Consignee, INNconsignee, BankConsignee, AddressConsignee) VALUES
                                                                                             ('AetherTech Innovations', 9876543210, 'SkyBank', '456 Cloud Plaza, Skylantis, Aetheria'),
...
INSERT INTO baltika.cargo (
    CustomValue, DepartureDate, ArriveDate, Origin, Destination, CustomClearance,
    Number, Shipment, DeclareValue, Unit, InsureValue, Sender, Consignee, Comment
) VALUES
      (1000, '2023-12-01', '2023-12-10', 1, 5, true, 12345, 'Electronics', 5000, 'Boxes', 2000, 1, 6, 'Fragile items'),
      (1500, '2023-12-05', '2023-12-15', 3, 7, false, 67890, 'Clothing', 3000, 'Packs', 1500, 2, 8, 'Fashion garments'),
      (800, '2023-12-10', '2023-12-20', 2, 6, true, 54321, 'Artwork', 7000, 'Crates', 2500, 3, 9, 'Handle with care'),
      (1200, '2023-12-15', '2023-12-25', 4, 8, false, 98765, 'Books', 4000, 'Pallets', 1800, 4, 10, 'Educational materials'),
      (900, '2023-12-20', '2023-12-30', 5, 9, true, 23456, 'Furniture', 6000, 'Pieces', 2200, 5, 11, 'Household items'),
      (2000, '2023-12-25', '2024-01-05', 6, 10, false, 87654, 'Toys', 2500, 'Cartons', 1200, 6, 12, 'Children''s playthings'),
      (1800, '2023-12-30', '2024-01-10', 7, 1, true, 32109, 'Electrical Appliances', 3500, 'Units', 1600, 7, 13, 'Home electronics'),
      (3000, '2024-01-05', '2024-01-15', 8, 2, false, 76543, 'Sporting Goods', 4500, 'Sets', 2000, 8, 14, 'Outdoor equipment'),
      (500, '2024-01-10', '2024-01-20', 9, 3, true, 21098, 'Cosmetics', 2000, 'Packages', 800, 9, 15, 'Beauty products'),
      (2500, '2024-01-15', '2024-01-25', 10, 4, false, 65432, 'Automotive Parts', 5500, 'Crates', 2400, 10, 16, 'Vehicle components'),
      (1200, '2024-01-20', '2024-01-30', 1, 5, true, 54321, 'Jewelry', 3000, 'Boxes', 1200, 11, 17, 'Valuable items'),
      (800, '2024-01-25', '2024-02-05', 3, 7, false, 98765, 'Perfumes', 1800, 'Bottles', 700, 12, 18, 'Fragrance products'),
      (1600, '2024-02-01', '2024-02-10', 2, 6, true, 32109, 'Food Products', 4000, 'Cartons', 1600, 13, 19, 'Perishable goods'),
      (2200, '2024-02-05', '2024-02-15', 4, 8, false, 76543, 'Musical Instruments', 6000, 'Cases', 2800, 14, 20, 'Melodic instruments'),
      (700, '2024-02-10', '2024-02-20', 5, 9, true, 21098, 'Tools', 2500, 'Toolboxes', 1000, 15, 3, 'Construction tools'),
      (1300, '2024-02-15', '2024-02-25', 6, 10, false, 65432, 'Home Decor', 3500, 'Pieces', 1400, 16, 2, 'Interior furnishings'),
      (1800, '2024-02-20', '2024-03-01', 7, 1, true, 54321, 'Fitness Equipment', 5000, 'Sets', 2200, 17, 3, 'Exercise gear'),
      (900, '2024-02-25', '2024-03-05', 8, 2, false, 98765, 'Pet Supplies', 2000, 'Packages', 900, 18, 4, 'Animal care products'),
      (2400, '2024-03-01', '2024-03-10', 9, 3, true, 32109, 'Tech Gadgets', 4000, 'Units', 1800, 19, 5, 'Electronic devices'),
      (1600, '2024-03-05', '2024-03-15', 10, 4, false, 76543, 'Outdoor Gear', 3000, 'Kits', 1200, 2, 6, 'Adventure equipment'),
      (1100, '2024-03-10', '2024-03-20', 1, 5, true, 21098, 'Gourmet Foods', 4500, 'Baskets', 2000, 3, 7, 'Delicacies'),
      (3000, '2024-03-15', '2024-03-25', 3, 7, false, 65432, 'Art Supplies', 5500, 'Crates', 2400, 2, 8, 'Creative materials'),
      (800, '2024-03-20', '2024-03-30', 2, 6, true, 54321, 'Fashion Accessories', 2000, 'Boxes', 800, 2, 9, 'Stylish items'),
      (1700, '2024-03-25', '2024-04-04', 4, 8, false, 98765, 'Educational Toys', 3500, 'Packages', 1500, 4, 3, 'Learning tools');